...
function draw_console_bar(console_string, color_string, sidetext_string, char_pos1, char_pos2, x, y, width){ with o_console.BAR {
...
var _char_height = o_console.char_height//string_height(" ")
var asp = _char_height/char_height

var _win_dist		= floor( win_dist*asp )
var _height			= ceil( height*asp )
var _sidebar_width	= floor( sidebar_width*asp )
var _text_dist		= ceil(	text_dist*asp )
var _sep			= ceil( sep*asp )
...
draw_console_body(right-sidetext_width-_text_dist*2, top, right, bottom)

clip_rect_cutout(left, top, right-sidetext_width-_text_dist*2-_sep+1, bottom+1)
draw_set_valign(fa_bottom)
if o_console.command_colors draw_console_text(text_x, text_y, color_string)		// Draw console colors

draw_set_color(o_console.colors.plain)
if not o_console.command_colors draw_text(text_x, text_y, console_string)		// Draw console string
...
draw_text(right-_text_dist, text_y, sidetext_string)
