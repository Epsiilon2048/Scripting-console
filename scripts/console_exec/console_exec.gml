...
for(var i = 0; i <= array_length(_console_string)-1; i++)
{
	...
	//if _output_string[i] != ""
	//{
	//	array_insert(log_list, array_length(log_list), _console_string[i], _output_string[i])
	//}
}
if log_to_window and array_length(_console_string) > 0 window(log_list, true)
